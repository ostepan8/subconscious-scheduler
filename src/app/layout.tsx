            ...
            <nav className="sticky top-0 z-40 border-b border-edge/60 bg-ink/90 backdrop-blur-xl">
              <div className="flex h-14 items-center justify-between px-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href="https://pypi.org/project/subconscious-sdk/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm text-subtle transition-colors hover:bg-surface hover:text-cream">
                  ...
                  <a href="https://www.npmjs.com/package/subconscious" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm text-subtle transition-colors hover:bg-surface hover:text-cream">
